          ...
          >
            <DialogContent className="dialog" dividers={scroll === 'paper'}>
              <CardContent
                ...
                style={{ height: '300px', paddingBottom: '0px' }}
                  ...
                  <Grid item container xs={12} style={{ margin: '5px' }}>
                    ...
                    <Grid item xs={3}>
                      ...
                      <Grid
                        ...
                        justify="center"
                      >
                        <Box className="nbg_bold black font-smooth">
                          플러스 인증
                        </Box>
                      </Grid>
                    </Grid>
